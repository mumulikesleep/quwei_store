...
class GoodsChannel(BaseModel):
    """商品频道"""
    group = models.ForeignKey(GoodsChannelGroup, on_delete=models.DO_NOTHING, verbose_name='频道组名')
...
class SKUImage(BaseModel):
    ...
    image = models.ImageField(verbose_name='图片')    #django自带的图片处理字段，处理图片需要安装Pillow模块
